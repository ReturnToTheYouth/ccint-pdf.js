...
function getNormalizeWithNFKC() {
  ...
  if (typeof PDFJSDev === "undefined" || PDFJSDev.test("TESTING")) {
    ...
    if (ranges.join("") !== NormalizeWithNFKC) {
      // Unicode normalization data can differ between JavaScript engines.
      // Use the table generated by the current runtime so search/autolinking
      // keeps working in development builds instead of failing completely.
